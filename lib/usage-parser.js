...
let PRICING_SNAPSHOT_AT = "2026-09-23";
...
let SOURCE_NOTE = {
  ...
  "Qwen/Qwen3-235B-A22B-Instruct-2507-tput": "together 官方定价页；官方美元价 ×6.8 折算；官方页未列缓存命中价，按输入价计；官方名 Qwen3 235B A22B Instruct 2507 FP8 Throughput",
  ...
  "anthropic/claude-opus-4.5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "anthropic/claude-opus-5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "anthropic/claude-sonnet-4.5": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "anthropic::claude-3-5-haiku": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Haiku 3.5 (retired, except on Bedrock and Google Cloud)；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-fable-5": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Fable 5；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-fable-5-1": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Fable 5.1；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-haiku-4-5": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Haiku 4.5；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-mythos-5": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Mythos 5 (limited availability)；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-mythos-5-1": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Mythos 5.1 (limited availability)；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-opus-4-1": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Opus 4.1 (retired, except on Bedrock and Google Cloud)；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-opus-4-5": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Opus 4.5；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-opus-4-6": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Opus 4.6；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-opus-4-7": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Opus 4.7；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-opus-4-8": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Opus 4.8；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-opus-5": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Opus 5；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-sonnet-4-5": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Sonnet 4.5；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-sonnet-4-6": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Sonnet 4.6；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  "anthropic::claude-sonnet-5": "anthropic 官方定价页；官方美元价 ×6.8 折算；官方名 Claude Sonnet 5；缓存写入（5 分钟 TTL）按输入价 1.25 倍",
  ...
  "dashscope::qwen-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen-long": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "dashscope::qwen-max": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "dashscope::qwen-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen-turbo": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen-vl-max": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "dashscope::qwen-vl-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "dashscope::qwen3-coder-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3-coder-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3-max": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3-vl-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3.5-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  ...
  "dashscope::qwen3.5-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3.6-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3.6-max-preview": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3.6-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3.8-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "dashscope::qwen3.8-max": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  ...
  "deepseek-r1": "siliconflow 官方定价页；官方页未列缓存命中价，按输入价计；官方名 deepseek-ai/DeepSeek-R1",
  "deepseek-v3.2": "siliconflow 官方定价页；官方名 deepseek-ai/DeepSeek-V3.2",
  ...
  "deepseek/deepseek-chat": "openrouter 官方定价页；官方美元价 ×6.8 折算；官方页未列缓存命中价，按输入价计",
  "deepseek/deepseek-v3.2": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  ...
  "fireworks::gpt-oss-120b": "fireworks 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers；官方名 accounts/fireworks/models/gpt-oss-120b",
  ...
  "google/gemini-2.5-flash": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "google/gemini-2.5-pro": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  ...
  "gpt-oss-120b": "fireworks 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers；官方名 accounts/fireworks/models/gpt-oss-120b",
  ...
  "kimi-k2.7-code": "官方定价",
  "meta-llama/Llama-3.3-70B-Instruct-Turbo": "together 官方定价页；官方美元价 ×6.8 折算；官方页未列缓存命中价，按输入价计",
  "mimo-v2.5": "mimo 官方定价页",
  "mimo-v2.5-pro": "mimo 官方定价页",
  "mimo::mimo-v2.5": "mimo 官方定价页",
  "mimo::mimo-v2.5-pro": "mimo 官方定价页",
  "minimax/minimax-m2.5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  ...
  "moonshotai/kimi-k2.5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  ...
  "openai/gpt-4o": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openai/gpt-5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openai/gpt-5.2": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openai/gpt-5.4": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openai/gpt-5.6-luna": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openai/gpt-5.6-sol": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openai/gpt-5.6-terra": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  ...
  "openrouter::anthropic/claude-opus-4.5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::anthropic/claude-opus-5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::anthropic/claude-sonnet-4.5": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openrouter::deepseek/deepseek-chat": "openrouter 官方定价页；官方美元价 ×6.8 折算；官方页未列缓存命中价，按输入价计",
  "openrouter::deepseek/deepseek-v3.2": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::google/gemini-2.5-flash": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::google/gemini-2.5-pro": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openrouter::minimax/minimax-m2.5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::moonshotai/kimi-k2.5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::openai/gpt-4o": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::openai/gpt-5": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::openai/gpt-5.2": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::openai/gpt-5.4": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openrouter::openai/gpt-5.6-luna": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openrouter::openai/gpt-5.6-sol": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openrouter::openai/gpt-5.6-terra": "openrouter 官方定价页；官方美元价 ×6.8 折算；分段计价，此处为主档，完整分档见 tiers",
  "openrouter::qwen/qwen3.5-397b-a17b": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::z-ai/glm-4.7": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::z-ai/glm-5.3": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "openrouter::z-ai/glm-5.3-flash": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  ...
  "qwen-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen-long": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "qwen-max": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "qwen-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen-turbo": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen-vl-max": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "qwen-vl-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "qwen/qwen3.5-397b-a17b": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "qwen3-coder-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3-coder-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3-max": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3-vl-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3.5-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3.5-omni-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "qwen3.5-omni-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "qwen3.5-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3.6-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3.6-max-preview": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3.6-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3.8-flash": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3.8-max": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计；分段计价，此处为主档，完整分档见 tiers",
  "qwen3:8b": "本地推理，无 API 费用（不走官方按量计费）",
  "qwq-plus": "dashscope 官方定价页；官方页未列缓存命中价，按输入价计",
  "siliconflow::deepseek-r1": "siliconflow 官方定价页；官方页未列缓存命中价，按输入价计；官方名 deepseek-ai/DeepSeek-R1",
  "siliconflow::deepseek-v3.2": "siliconflow 官方定价页；官方名 deepseek-ai/DeepSeek-V3.2",
  ...
  "together::Qwen/Qwen3-235B-A22B-Instruct-2507-tput": "together 官方定价页；官方美元价 ×6.8 折算；官方页未列缓存命中价，按输入价计；官方名 Qwen3 235B A22B Instruct 2507 FP8 Throughput",
  "together::meta-llama/Llama-3.3-70B-Instruct-Turbo": "together 官方定价页；官方美元价 ×6.8 折算；官方页未列缓存命中价，按输入价计",
  "together::openai/gpt-oss-120b": "together 官方定价页；官方美元价 ×6.8 折算；官方页未列缓存命中价，按输入价计",
  ...
  "z-ai/glm-4.7": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "z-ai/glm-5.3": "openrouter 官方定价页；官方美元价 ×6.8 折算",
  "z-ai/glm-5.3-flash": "openrouter 官方定价页；官方美元价 ×6.8 折算",
...
let PRICING = {
  ...
  "Qwen/Qwen3-235B-A22B-Instruct-2507-tput": { inputMiss: 1.36, inputHit: 1.36, output: 4.08 },
  ...
  "deepseek-r1": { inputMiss: 4, inputHit: 4, output: 16 },
  "deepseek-v3.2": { inputMiss: 4, inputHit: 0.4, output: 6 },
  "deepseek-v4-flash": {
    peak: { inputMiss: 2, inputHit: 0.04, output: 8 },
    offPeak: { inputMiss: 1, inputHit: 0.02, output: 4 },
  },
  ...
  "deepseek/deepseek-chat": { inputMiss: 2.18, inputHit: 2.18, output: 6.05 },
  "deepseek/deepseek-v3.2": { inputMiss: 1.83, inputHit: 0.91, output: 2.72 },
  ...
  "fireworks::gpt-oss-120b": { inputMiss: 1.02, inputHit: 0.1, output: 4.08 },
  "gemini-2.5-flash": { inputMiss: 2.04, inputHit: 0.2, output: 17 },
  "gemini-2.5-flash-lite": { inputMiss: 0.68, inputHit: 0.07, output: 2.72 },
  "gemini-2.5-pro": { inputMiss: 8.5, inputHit: 0.85, output: 68 },
  "gemini-3-flash-preview": { inputMiss: 3.4, inputHit: 0.34, output: 20.4 },
  "gemini-3.1-flash-lite-preview": { inputMiss: 1.7, inputHit: 0.17, output: 10.2 },
  "gemini-3.1-pro-preview": { inputMiss: 13.6, inputHit: 1.36, output: 81.6 },
  "gemini-3.7-flash": { inputMiss: 5.1, inputHit: 0.51, output: 25.5 },
  "gemini-3.8-flash": { inputMiss: 5.1, inputHit: 0.51, output: 25.5 },
  "gemini::gemini-2.5-flash": { inputMiss: 2.04, inputHit: 0.2, output: 17 },
  "gemini::gemini-2.5-flash-lite": { inputMiss: 0.68, inputHit: 0.07, output: 2.72 },
  "gemini::gemini-2.5-pro": { inputMiss: 8.5, inputHit: 0.85, output: 68 },
  "gemini::gemini-3-flash-preview": { inputMiss: 3.4, inputHit: 0.34, output: 20.4 },
  "gemini::gemini-3.1-flash-lite-preview": { inputMiss: 1.7, inputHit: 0.17, output: 10.2 },
  "gemini::gemini-3.1-pro-preview": { inputMiss: 13.6, inputHit: 1.36, output: 81.6 },
  "gemini::gemini-3.7-flash": { inputMiss: 5.1, inputHit: 0.51, output: 25.5 },
  "gemini::gemini-3.8-flash": { inputMiss: 5.1, inputHit: 0.51, output: 25.5 },
  ...
  "google/gemini-2.5-flash": { inputMiss: 2.04, inputHit: 0.2, output: 17 },
  "google/gemini-2.5-pro": { inputMiss: 8.5, inputHit: 0.85, output: 68 },
  ...
  "gpt-oss-120b": { inputMiss: 1.02, inputHit: 0.1, output: 4.08 },
  ...
  "meta-llama/Llama-3.3-70B-Instruct-Turbo": { inputMiss: 7.07, inputHit: 7.07, output: 7.07 },
  "mimo-v2.5": { inputMiss: 1, inputHit: 0.02, output: 2 },
  "mimo-v2.5-pro": { inputMiss: 3, inputHit: 0.025, output: 6 },
  "mimo::mimo-v2.5": { inputMiss: 1, inputHit: 0.02, output: 2 },
  "mimo::mimo-v2.5-pro": { inputMiss: 3, inputHit: 0.025, output: 6 },
  "minimax/minimax-m2.5": { inputMiss: 1.84, inputHit: 0.18, output: 7.34 },
  ...
  "moonshotai/kimi-k2.5": { inputMiss: 3.06, inputHit: 0.48, output: 15.3 },
  ...
  "openai/gpt-5.6-sol": { inputMiss: 13.6, inputHit: 1.36, output: 68 },
  ...
  "openrouter::anthropic/claude-opus-4.5": { inputMiss: 34, inputHit: 3.4, output: 170 },
  "openrouter::anthropic/claude-opus-5": { inputMiss: 34, inputHit: 3.4, output: 170 },
  "openrouter::anthropic/claude-sonnet-4.5": { inputMiss: 20.4, inputHit: 2.04, output: 102 },
  "openrouter::deepseek/deepseek-chat": { inputMiss: 2.18, inputHit: 2.18, output: 6.05 },
  "openrouter::deepseek/deepseek-v3.2": { inputMiss: 1.83, inputHit: 0.91, output: 2.72 },
  "openrouter::google/gemini-2.5-flash": { inputMiss: 2.04, inputHit: 0.2, output: 17 },
  "openrouter::google/gemini-2.5-pro": { inputMiss: 8.5, inputHit: 0.85, output: 68 },
  "openrouter::minimax/minimax-m2.5": { inputMiss: 1.84, inputHit: 0.18, output: 7.34 },
  "openrouter::moonshotai/kimi-k2.5": { inputMiss: 3.06, inputHit: 0.48, output: 15.3 },
  "openrouter::openai/gpt-4o": { inputMiss: 17, inputHit: 8.5, output: 68 },
  "openrouter::openai/gpt-5": { inputMiss: 8.5, inputHit: 0.85, output: 68 },
  "openrouter::openai/gpt-5.2": { inputMiss: 11.9, inputHit: 1.19, output: 95.2 },
  "openrouter::openai/gpt-5.4": { inputMiss: 17, inputHit: 1.7, output: 102 },
  "openrouter::openai/gpt-5.6-luna": { inputMiss: 1.36, inputHit: 0.14, output: 8.16 },
  "openrouter::openai/gpt-5.6-sol": { inputMiss: 13.6, inputHit: 1.36, output: 68 },
  "openrouter::openai/gpt-5.6-terra": { inputMiss: 13.6, inputHit: 1.36, output: 81.6 },
  "openrouter::qwen/qwen3.5-397b-a17b": { inputMiss: 3.74, inputHit: 1.53, output: 23.8 },
  "openrouter::z-ai/glm-4.7": { inputMiss: 2.72, inputHit: 0.54, output: 11.9 },
  "openrouter::z-ai/glm-5.3": { inputMiss: 4.45, inputHit: 0.83, output: 13.97 },
  "openrouter::z-ai/glm-5.3-flash": { inputMiss: 1.02, inputHit: 0.34, output: 3.4 },
  ...
  "qwen/qwen3.5-397b-a17b": { inputMiss: 3.74, inputHit: 1.53, output: 23.8 },
  ...
  "siliconflow::deepseek-r1": { inputMiss: 4, inputHit: 4, output: 16 },
  "siliconflow::deepseek-v3.2": { inputMiss: 4, inputHit: 0.4, output: 6 },
  ...
  "together::Qwen/Qwen3-235B-A22B-Instruct-2507-tput": { inputMiss: 1.36, inputHit: 1.36, output: 4.08 },
  "together::meta-llama/Llama-3.3-70B-Instruct-Turbo": { inputMiss: 7.07, inputHit: 7.07, output: 7.07 },
  "together::openai/gpt-oss-120b": { inputMiss: 1.02, inputHit: 1.02, output: 4.08 },
  ...
  "z-ai/glm-4.7": { inputMiss: 2.72, inputHit: 0.54, output: 11.9 },
  "z-ai/glm-5.3": { inputMiss: 4.45, inputHit: 0.83, output: 13.97 },
  "z-ai/glm-5.3-flash": { inputMiss: 1.02, inputHit: 0.34, output: 3.4 },
...
let PROVIDER_OF_MODEL = {
  ...
  "fireworks::gpt-oss-120b": "fireworks",
  ...
  "openrouter::openai/gpt-5.6-sol": "openrouter",
  "openrouter::openai/gpt-5.6-terra": "openrouter",
  "openrouter::qwen/qwen3.5-397b-a17b": "openrouter",
  "openrouter::z-ai/glm-4.7": "openrouter",
  "openrouter::z-ai/glm-5.3": "openrouter",
  ...
  "qwen3:8b": "ollama",
  "qwq-plus": "dashscope",
  "siliconflow::deepseek-r1": "siliconflow",
  "siliconflow::deepseek-v3.2": "siliconflow",
  "sonar": "perplexity",
...
let CONTEXT_WINDOW = {
  ...
  "openrouter::deepseek/deepseek-chat": 131072,
  "openrouter::deepseek/deepseek-v3.2": 131072,
  "openrouter::google/gemini-2.5-flash": 1048576,
  "openrouter::google/gemini-2.5-pro": 1048576,
  "openrouter::minimax/minimax-m2.5": 204800,
  ...
  "openrouter::qwen/qwen3.5-397b-a17b": 256000,
  ...
  "together::Qwen/Qwen3-235B-A22B-Instruct-2507-tput": 262144,
...
// 高峰时段：北京时间 周一至周五 9:00-12:00、14:00-18:00，其余空闲（空闲价 = 高峰价一半）
// 周末全天按空闲价。此前只判小时不判星期，周末会被当成高峰多算一倍。
function isPeakHour(ts) {
  const d = ts ? new Date(ts) : null;
  if (!d || Number.isNaN(d.getTime())) return true; // 时间戳缺失/异常时按高峰价（保守）
  const cn = new Date(d.getTime() + 8 * 3600e3); // 平移到北京时间的 UTC 读数
  const weekday = cn.getUTCDay(); // 0=周日, 6=周六
  if (weekday === 0 || weekday === 6) return false;
  const beijingHour = cn.getUTCHours();
