...
const PRICING_SNAPSHOT_AT = "2026-08-27";

// 每条价格模型的来源标注（官方 / 估算 / 免费），用于透明呈现
const SOURCE_NOTE = {
  "deepseek-v4-flash": "官方峰谷计价",
  "deepseek-v4-flash-vision-exp": "估算（按 flash 档位）",
...
export { parseSession, PRICING, PROVIDER_OF_MODEL, CONTEXT_WINDOW, round, priceFor, isPeakHour, SOURCE_NOTE, PRICING_SNAPSHOT_AT };
